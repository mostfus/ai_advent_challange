...
### Six servers, five of them somebody else's
...
|---|---|---|---|
| **Google Maps (local)** | `127.0.0.1:8787/mcp` | 2 | **Ours** — `maps_mcp_server.py`, day 17. Distance A→B, restaurants nearby. |
