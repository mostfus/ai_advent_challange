...
def build_agent(settings: Settings, plan: ContextPlan, profile: Profile | None = None) -> Agent:
...
def post_chat(req: ChatRequest) -> dict:
    ...
    return as_json(reply, conversation, plan, proposals, personality=profile_record)
