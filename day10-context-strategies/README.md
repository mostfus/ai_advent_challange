...
Every one of them starts from the same cut. The window — the last N messages — is sent verbatim, always. What they disagree about is everything in front of it.
...
## Four kinds of forgetting, kept distinct

| | Messages | Facts / summary | Branches | The chat |
|---|---|---|---|---|
| **Forget facts** / **Forget summary** | kept | gone | kept | kept |
| **✕** on a branch chip | that branch's only | that branch's only | one gone | kept |
| **Clear context** | gone | gone | gone | kept |
...
In the single chat, **⚙ Settings** opens on two:
