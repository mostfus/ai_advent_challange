...
LONG_TERM_PREFIX = (
    "What you know about this user and how they want to be answered, filed by "
    "them and carried into every conversation. These are standing "
    "instructions, not a record of anything said here - follow them unless "
    "this conversation explicitly overrides one:\n\n"
)
